  ...
  return (
    <>
      ...
      <section className="space-y-4">
        ...
        <p>
          If you experience any issues with your subscription, payments, or have a refund inquiry, please reach out to us at: <a href="mailto:support@auvora.com" className="text-amber-400 hover:underline">support@auvora.com</a>.
        </p>
      </section>
    </>
  );
