  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-5 transition hover:border-zinc-700">
      ...
      <div className="space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-zinc-800/60 pb-3">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-sm font-mono text-zinc-400">#0{index + 1}</span>
            <span className="inline-flex items-center rounded-md bg-zinc-800 px-2.5 py-0.5 text-sm font-medium text-zinc-300 border border-zinc-700">
              {typeLabel}
            </span>
      ...
      <div className="space-y-1">
        ...
        <p className="text-base text-zinc-300 leading-relaxed">{pattern.description}</p>
      </div>
