  ...
  return (
    <section id="risks" className="scroll-mt-24 space-y-6">
      <div className="space-y-1">
        <h2 className="text-xl font-bold tracking-tight text-white">Risk Analysis</h2>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {risks.map((risk, idx) => (
          ...
          >
            ...
            <p className="text-xs text-zinc-300 leading-relaxed">{risk.description}</p>

            <div className="flex items-center justify-between text-[11px] text-zinc-400 pt-1 border-t border-zinc-850">
            ...
            <div className="rounded-lg border border-zinc-850 bg-zinc-950/60 p-3 text-xs space-y-1">
