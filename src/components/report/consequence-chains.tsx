  ...
  return (
    <section id="consequences" className="scroll-mt-24 space-y-6">
      <div className="space-y-1">
        <h2 className="text-xl font-bold tracking-tight text-white">Second-Order Consequences</h2>
          ...
          >
            ...
            <div className="relative pl-6 space-y-4 border-l-2 border-zinc-800">
              ...
              <div className="relative space-y-1">
                ...
                <p className="text-xs text-zinc-200">{chain.immediate_effect}</p>
              </div>
              ...
              <div className="relative space-y-1">
                ...
                <p className="text-xs font-medium text-purple-200">{chain.second_order_effect}</p>
              </div>
              ...
              <div className="relative space-y-1">
                ...
                <p className="text-xs text-zinc-300">{chain.potential_third_order_effect}</p>
              </div>
            </div>
